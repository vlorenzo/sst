...
def create_app(input_lang='it', output_lang='en', use_gpt4_translation=False, use_overlapping_chunks=True):
    ...
    app.config['USE_OVERLAPPING_CHUNKS'] = use_overlapping_chunks  # Add this line
